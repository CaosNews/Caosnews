# Generated by Django 4.1.2 on 2023-07-08 18:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Form_contact',
            fields=[
                ('id_form_cont', models.AutoField(db_column='Id_form_cont', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Parti',
            fields=[
                ('id_parti', models.AutoField(db_column='Id_Parti', primary_key=True, serialize=False)),
                ('Nombre', models.CharField(max_length=30)),
                ('Apellido', models.CharField(max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_parti', models.ForeignKey(db_column='Id_Parti', limit_choices_to={'id_tp_part': 1}, on_delete=django.db.models.deletion.CASCADE, to='noticias.parti')),
            ],
        ),
        migrations.CreateModel(
            name='Foto',
            fields=[
                ...
                ('id_noticia', models.ForeignKey(db_column='Id_Noticia', on_delete=django.db.models.deletion.CASCADE, to='noticias.noticia')),
            ],
        ),
    ]
